...
document.getElementById('test-form')?.addEventListener('submit', function (event) {
    ...
    if (checkAnswer('q5', q5Answer, correctAnswers.q5)) score++;
    if (checkAnswer('q6', q6Answer, correctAnswers.q6)) score++;
...
function loadProfileData() {
    ...
    if (testScore) {
        const parsedScore = parseInt(testScore);
        if (!isNaN(parsedScore)) {
            document.getElementById('user-score').textContent = `${parsedScore} балл(ов)`;
            document.getElementById('user-correct').textContent = parsedScore;
            document.getElementById('user-incorrect').textContent = 6 - parsedScore;
        } else {
            document.getElementById('user-score').textContent = '';
            document.getElementById('user-correct').textContent = '';
            document.getElementById('user-incorrect').textContent = '';
        }
    } else {
        document.getElementById('user-score').textContent = "";
        document.getElementById('user-correct').textContent = "";
